							...
							<div class="col">
                                <div class="doctor-table-blk">
									...
									<div class="doctor-search-blk">
										<div class="add-group">
											<a wire:click="AddTask" class="btn btn-primary ms-2"><img src="{{ asset('assets/img/icons/plus.svg') }}" alt>
											</a>
										</div>
									</div>
								</div>
									...
									<tr>
										...
										<td class="text-center">
											<div class="btn-group" role="group">
												...
												<a class="btn btn-danger btn-sm mx-1" wire:click="deleteTask({{ $task->id }})" title="Delete">
