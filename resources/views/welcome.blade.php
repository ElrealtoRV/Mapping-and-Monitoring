...
<head>
    ...
    <link rel="icon" type="image/png" href="{{ asset('assets/img/fireICon.png') }}">
...
@media (max-width: 768px) {
    ...
    main {
        padding-top: 80px; /* Adjust padding to prevent content from being hidden under the fixed header */
    }
